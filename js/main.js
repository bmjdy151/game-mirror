...
const canvas0 = document.getElementById("canvas0");       // canvas 要素の取得
const canvas = document.getElementById("canvas");       // canvas 要素の取得
const canvas2 = document.getElementById("canvas2");       // canvas 要素の取得
const context0 = canvas0.getContext("2d");                // canvas の context の取得
...
function drawLoop() {
  ...
  if(startcheck){
    ...
    // context.drawImage(video, 0, 0, 500, 400);       // 画像を描く
    //以下目ロジック
    ...
    switch (score){
      case 150:
        ...
        break;
      case 100:
        context2.fillStyle = `rgb(0,191,255)`;;
      ...
      case 10:
        ...
        context2.fillText("You Look Scary", 10, 50);
        break;
      case 0:
...
eoption2.addEventListener("click", function() {
  eye_selection = "blue";
   if(hat_selection == "hat" || hat_selection == "bheadphone" || acc_selection == "nose"){
    score = 50;
   }else{
    score =0;
   }
...
haption1.addEventListener("click", function() {
  ...
  if(eye_selection == "red" && acc_selection == "nose" && cheek_selection !== "none"){
    ...
    score = 50;
   }else if(acc_selection == "mustache"||acc_selection == "cigar"){
    score = -50;
   }else{
    score =0;
   }
...
haption3.addEventListener("click", function() {
  hat_selection = "hat";
  if(eye_selection == "blue" && acc_selection == "mustache" || acc_selection == "cigar"){
    score = 100;
  }else if(eye_selection == "blue"){
    score = 50;
  }else{
...
aoption1.addEventListener("click", function() {
  acc_selection = "mustache";
   if(hat_selection == "bheadphone"  || hat_selection == "hat" || eye_selection == "sun" || eye_selection == "blue"){
    score = 50;
   }else if(cheek_selection !== "none" || hat_selection == "bunny" || hat_selection == "crown"){
    score = -50;
   }else{
    score =0;
   }
